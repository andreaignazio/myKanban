...
type SubscriptionFailedModalProps = {
    onClose?: () => void
}

export const SubscriptionFailedModal = ({ onClose }: SubscriptionFailedModalProps) => {
    return (
        <div className="relative flex flex-col items-center justify-center w-[340px] px-8 pt-12 pb-8 gap-6 overflow-hidden">
            ...
            <div className="relative flex items-center justify-center">
                ...
                />
                <motion.div
                    className="relative z-10 flex items-center justify-center rounded-full border-2 border-rose-400 bg-rose-400/10"
                ...
                >
                    ...
                    >
                        <XMarkIcon className="w-9 h-9 text-rose-400" />
                    </motion.div>
                </motion.div>
            </div>
            ...
            >
                <h2 className="text-2xl font-bold text-neutral-100 tracking-tight">Payment Failed</h2>
                <p className="text-sm text-neutral-400 leading-relaxed">
                    We couldn't process your payment.<br />Please check your payment details and try again.
                </p>
            </motion.div>
            ...
            >
                <LabeledButtonPresetA
                    label="Try Again"
                    onClick={() => onClose?.()}
                    className="w-full !h-11 !rounded-full !bg-rose-500 hover:!bg-rose-400 !text-neutral-100 !font-bold text-base"
                />
            </motion.div>
        </div>
    )
