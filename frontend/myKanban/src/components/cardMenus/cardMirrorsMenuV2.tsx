...
export const CardMirrorsMenuV2 = forwardRef<HTMLDivElement, CardMirrorsMenuProps>(({ cardId, listCardId, onClose }, ref) => {
    ...
    return (
        <CommonMenuWrapper ref={ref} Title="Mirrors" onClose={onClose}
            className="w-[300px]">
            <div className="flex flex-col gap-2 w-full h-fit py-4 px-2">
                {boardIds.length === 0 && (
...
const MirrorBoardSection = ({ cardId, boardId, mirrorIds, renderData, onMirrorMenuClose }: MirrorBoardSectionProps) => {
    ...
    return (
        <div
            ...
            className="relative group flex flex-col rounded-xl overflow-hidden pt-4  w-full gap-2">
            <ImageColorRenderer
                overrideClassName
            ...
            <div className="relative z-10 flex flex-col items-center gap-2 ">
                ...
                rounded-xl justify-between">
                   ...
                   gap-0">
                    ...
                    <CardLabelsRenderer cardLabels={labelsForBoard} />
                    {mirrorIds.length > 0 && (
            ...
            >
                ...
                <div className="grid grid-cols-[1fr_32px] w-full">
                    <div className="col-span-1 flex flex-col gap-0">
                        ...
                        <div className="flex flex-row items-center opacity-20 group-hover/list:opacity-50 transition-all duration-200  ease-in-out mt-0.5 gap-1.5">
                            <span className={`${textClassMuted} opacity-50 font-mono text-xs font-normal`}>{accessModeLabel}</span>
